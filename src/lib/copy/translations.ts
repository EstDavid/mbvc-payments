...
const translations: Record<Language, Record<string, string | Record<string, string>>> = {
  es: {
    ...
    services: {
      ...
      dropIn: "Clase suelta",
      tournament: "Torneo nocturno 11 julio",
    },
    amount: "Cantidad",
    ...
    ifNoNotification: "Si no recibes una notificación en unos segundos, verifica la aplicación de tu banco o Bizum.",
  ...
  en: {
    ...
    services: {
      ...
      tournament: "Night tournament July 11th",
    },
    amount: "Amount",
    ...
    ifNoNotification: "If you do not receive a notification in a few seconds, check your bank or Bizum app.",
